module.exports = {
    ...
    changelog: "After using a command on one server by the user, the cooldown does not affect the other server if the command was not used by the same user ~@miroxik74",
